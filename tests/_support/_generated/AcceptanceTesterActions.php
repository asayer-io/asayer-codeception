<?php  //[STAMP] 1df2080592e9cf9a3ea4e474f7e07490
...
trait AcceptanceTesterActions
{
     ...
     *
     *
     * @see \Helper\AsayerAcceptance::markSession()
     */
    public function markSession($state) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('markSession', func_get_args()));
    }
     ...
     *
     *
     * @see \Helper\AsayerAcceptance::markSessionDetails()
     */
    public function markSessionDetails($state, $requirementID, $testStatus) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('markSessionDetails', func_get_args()));
    }
}
